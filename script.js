...
// Antelope Valley / North County
  ...
  "Topanga":                      { region:"West LA",  status:"Higher income / lower poverty",   poverty_pct:7.2,  sf_pct:86 },
  "Stevenson Ranch":              { region:"North LA", status:"Higher income / lower poverty",   poverty_pct:6.4,  sf_pct:82 },
  "Valley Glen":                  { region:"North LA", status:"Mixed income / moderate poverty", poverty_pct:18.2, sf_pct:48 },
  "Griffith Park":                { region:"North LA", status:"Mixed income / moderate poverty", poverty_pct:11.4, sf_pct:58 },
  "Hollywood Hills":              { region:"North LA", status:"Mixed income / moderate poverty", poverty_pct:12.1, sf_pct:71 },
  "Veterans Administration":      { region:"West LA",  status:"Mixed income / moderate poverty", poverty_pct:12.8, sf_pct:18 },
  "Baldwin Hills/Crenshaw":       { region:"South LA", status:"Mixed income / moderate poverty", poverty_pct:22.8, sf_pct:44 },
  "Historic South-Central":       { region:"South LA", status:"Lower income / higher poverty",   poverty_pct:32.1, sf_pct:28 },
  "Florence-Firestone":           { region:"South LA", status:"Lower income / higher poverty",   poverty_pct:31.4, sf_pct:34 },
  "Lennox":                       { region:"South LA", status:"Lower income / higher poverty",   poverty_pct:30.8, sf_pct:28 },
  "Ladera Heights":               { region:"West LA",  status:"Higher income / lower poverty",   poverty_pct:8.4,  sf_pct:72 },
  "West Compton":                 { region:"South LA", status:"Lower income / higher poverty",   poverty_pct:28.4, sf_pct:52 },
  "East Compton":                 { region:"South LA", status:"Lower income / higher poverty",   poverty_pct:27.8, sf_pct:48 },
  "Rancho Dominguez":             { region:"South LA", status:"Mixed income / moderate poverty", poverty_pct:22.4, sf_pct:44 },
  "West Carson":                  { region:"South LA", status:"Mixed income / moderate poverty", poverty_pct:16.8, sf_pct:58 },
  "Palmdale":                     { region:"North LA", status:"Mixed income / moderate poverty", poverty_pct:20.4, sf_pct:66 },
  "Lake Hughes":                  { region:"North LA", status:"Higher income / lower poverty",   poverty_pct:9.8,  sf_pct:84 },
  "Hasley Canyon":                { region:"North LA", status:"Higher income / lower poverty",   poverty_pct:7.2,  sf_pct:88 },
  "Whittier Narrows":             { region:"East LA",  status:"Mixed income / moderate poverty", poverty_pct:16.4, sf_pct:52 },
  "North Whittier":               { region:"East LA",  status:"Mixed income / moderate poverty", poverty_pct:13.8, sf_pct:64 },
  "South Whittier":               { region:"East LA",  status:"Mixed income / moderate poverty", poverty_pct:16.2, sf_pct:62 },
  "West Whittier-Los Nietos":     { region:"East LA",  status:"Mixed income / moderate poverty", poverty_pct:18.4, sf_pct:56 },
  "Valinda":                      { region:"East LA",  status:"Mixed income / moderate poverty", poverty_pct:17.8, sf_pct:58 },
  "North El Monte":               { region:"East LA",  status:"Mixed income / moderate poverty", poverty_pct:19.2, sf_pct:48 },
  "East San Gabriel":             { region:"East LA",  status:"Mixed income / moderate poverty", poverty_pct:14.8, sf_pct:56 },
  "Mayflower Village":            { region:"East LA",  status:"Mixed income / moderate poverty", poverty_pct:16.4, sf_pct:58 },
  "Vincent":                      { region:"East LA",  status:"Mixed income / moderate poverty", poverty_pct:15.8, sf_pct:62 },
  "Covina":                       { region:"East LA",  status:"Mixed income / moderate poverty", poverty_pct:14.2, sf_pct:58 },
  "Citrus":                       { region:"East LA",  status:"Mixed income / moderate poverty", poverty_pct:12.8, sf_pct:64 },
  "South Whittier":               { region:"East LA",  status:"Mixed income / moderate poverty", poverty_pct:16.2, sf_pct:62 },
  "Agoura Hills":                 { region:"West LA",  status:"Higher income / lower poverty",   poverty_pct:5.8,  sf_pct:82 },
